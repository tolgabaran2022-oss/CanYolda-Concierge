...
const cr = StyleSheet.create({
  ...
  heroCard:       { backgroundColor: WHITE, borderRadius: 24, borderWidth: 1, borderColor: BORDER, flexDirection: "row", overflow: "hidden" },
  heroLeft:       { flex: 1, padding: 22, gap: 12, justifyContent: "center" },
  heroIconCircle: { width: 58, height: 58, borderRadius: 29, alignItems: "center", justifyContent: "center" },
  heroTitle:      { fontSize: 18, fontFamily: "Inter_700Bold", color: DARK, lineHeight: 26 },
  heroSub:        { fontSize: 13, fontFamily: "Inter_400Regular", color: BODY, lineHeight: 20 },
  ctaBtn:         { borderRadius: 50, overflow: "hidden", marginTop: 6 },
  ctaGrad:        { flexDirection: "row", alignItems: "center", gap: 7, paddingVertical: 13, paddingHorizontal: 18, justifyContent: "center" },
  ctaTxt:         { fontSize: 14, fontFamily: "Inter_700Bold", color: WHITE },
  heroRight:      { width: 148 },
  dogImg:         { width: "100%", height: 230 },
